...
class ColorConstants {
  ...
  static const Color lightGreen = Color(0xFFD5E8CA);
  static const Color lightGrey = Color(0xFFF6F6F6);
  static const Color mineShaft = Color(0xff242424);
  static const Color offWhite = Color(0xFFf5f5f5);
  static const Color offBlack = Color(0xFF313639);
  static const Color red = Colors.red;
  static const Color shadedGrey = Color(0xFFB8B8B8);
  static const Color greyOff = Color(0xFFD9D9D9);
